    ...
    <nav id="topbar">
        <ul class="navbar-nav theme-brand flex-row  text-center">
            <li class="nav-item theme-logo">
                <a href="{{ route('home') }}">
                    <img src="{{ asset('assets/square-logo-no-text.png') }}" class="navbar-logo" alt="logo">
                </a>
            </li>
            <li class="nav-item theme-text">
                <a href="{{ route('home') }}" class="nav-link"> Central </a>
            </li>
        </ul>
        ...
        <ul class="list-unstyled menu-categories" id="topAccordion">
            ...
            @role('user')
                <li class="menu single-menu 
                    ...
                    @endif
                ">
                    <a href="{{ route('user.application') }}" data-toggle="" aria-expanded="true" class="dropdown-toggle autodroprown">
                        <div class="">
            ...
            <li class="menu single-menu">
                <a href="#privilege" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
